...
// Video YouTube ID
$youtubeVideoId = 'wuuRIhaNvGY'; // Ganti dengan ID video YouTube Anda
?>
                    ...
                    <div class="bg-white rounded-lg overflow-hidden shadow-lg card-hover">
                        ...
                        <div class="p-6">
                            ...
                            <div class="border-t pt-4">
                                <p class="text-3xl font-bold text-blue-600 mb-2"><?php echo $paket['harga']; ?></p>
                                <p class="text-green-600 font-semibold mb-4">🎉 <?php echo $paket['promo']; ?></p>
